...
|---|---|---|
| 🖥️ **Installer (EXE)** | `ZenDesktop-1.0.9-setup.exe` | Most users — wizard installer with Start Menu shortcut |
| 📦 **Installer (MSI)** | `ZenDesktop-v1.0.9-x64.msi` | Enterprises / system-wide installs with clean uninstall |
| 💾 **Portable** | `ZenDesktop-v1.0.9-portable.zip` | USB drives, custom paths, no installation |

All downloads are available at **[Releases](https://github.com/jaimitus/ZenDesktop/releases)**.

### 🖥️ EXE Installer (recommended)

1. Download `ZenDesktop-1.0.9-setup.exe` from [Releases](https://github.com/jaimitus/ZenDesktop/releases)
...
1. Download `ZenDesktop-v1.0.9-x64.msi` from [Releases](https://github.com/jaimitus/ZenDesktop/releases)
...
1. Download `ZenDesktop-v1.0.9-portable.zip` from [Releases](https://github.com/jaimitus/ZenDesktop/releases)
